export type ViewportBand = 'mobile-small' | 'mobile' | 'desktop' | 'wide';
...
/** US-popular sizes + Tailwind band boundaries (mobile-small ≤390, desktop ≥860, wide ≥1280). */
export const viewports: ViewportDef[] = [
  ...
  { id: 'desktop-860', width: 860, height: 900, band: 'desktop', label: 'desktop floor' },
  { id: 'laptop-1100', width: 1100, height: 900, band: 'desktop', label: 'Laptop + sidebar' },
  { id: 'wide-1280', width: 1280, height: 900, band: 'wide', label: 'wide floor' },
  { id: 'laptop-1366', width: 1366, height: 768, band: 'wide', label: 'Classic laptop' },
...
export const aboutViewports = viewports.filter((v) =>
  ['phone-390', 'wide-1280'].includes(v.id),
);
